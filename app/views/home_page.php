            ...
            <section class="max-w-6xl mx-auto mb-12 bg-white rounded-xl shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-green-50 rounded-xl shadow-md p-6 flex flex-col items-center text-center border border-green-200">
                        ...
                        <!-- View availability via booking_slots.php -->



                        <a href="../core/availibility.php?facility_id=1"
                            class="bg-green-600 text-white py-2 px-6 rounded-lg hover:bg-green-700 transition-colors duration-200 shadow-md">
                            Book Now
                        </a>
                    </div>
            ...
            <section class="max-w-6xl mx-auto mb-12 bg-white rounded-xl shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-blue-50 rounded-xl shadow-md p-6 flex flex-col items-center text-center border border-blue-200">
                        ...
                        <!-- </button> -->
                         <a href="../core/availibility.php?facility_id=1"
                            class="bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-md">
                            Book Now
                        </a>
                    </div>
